...
// Cognition
* Age
gen age_cog_07 = DAGEDY000 / 365.25 if DAGEDY000 >= 0
gen age_cog_11 = EMCS5AGE if inrange(EMCS5AGE, 10, 13) // MCSage10 / 12
gen age_cog_14 = FCMCS6AG if inrange(FCMCS6AG, 13, 16) // MCSage14 / 12
gen age_cog_17 = GCMCS7AG if GCMCS7AG >= 0
